...
import { ChevronLeft, Bookmark, MapPin, Film } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {bookmarks.map((bookmark) => (
              <Link
                ...
                className="group p-6 bg-white/5 rounded-3xl border border-white/5 hover:border-antique-ivory/30 transition-all hover:scale-[1.02]"
              >
